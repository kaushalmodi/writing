...
// needs Org.Converter.js at the moment
...
(function () {
    ...
    Org.Editor = function (orgConverter, idPostfix, options) {
        ...
        var hooks = this.hooks = new Org.HookCollection();
        ...
        this.getConverter = function () { return orgConverter; }
        ...
        this.run = function () {
            ...
            var previewManager = new PreviewManager(orgConverter, panels, function () { hooks.onPreviewRefresh(); });
    ...
    commandProto.doBlockquote = function (chunk, postProcessing) {
        ...
        */
        ...
        var replaceBlanksInTags = function (useBracket) {
            ...
            if (chunk.startTag) {
                chunk.startTag = chunk.startTag.replace(/\n((>|\s)*)\n$/,
                    function (totalMatch, org) {
                        return "\n" + org.replace(/^[ ]{0,3}>?[ \t]*$/gm, replacement) + "\n";
                    });
            }
            if (chunk.endTag) {
