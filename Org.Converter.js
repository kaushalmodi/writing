...
//   var text = "Org *rocks*.";
//
//   var converter = new Org.Converter();
...
(function () {
    ...
    Org.HookCollection = HookCollection;
    ...
    SaveHash.prototype = {
        ...
        Org.Converter = function (OPTIONS) {
        var pluginHooks = this.hooks = new HookCollection();

        // given a URL that was encountered by itself (without markup), should return the link text that's to be given to this link
        pluginHooks.addNoop("plainLinkText");

        // called with the orignal text as given to makeHtml. The result of this plugin hook is the actual org source that will be cooked
        ...
        if (OPTIONS.nonAsciiLetters) {
             ...
             * of a unicode word character in the Org source that is not
        ...
        function _RunBlockGamut(text, doNotUnhash) {
            ...
            // We already ran _HashHTMLBlocks() before, in Org(), but that
            // was to escape raw HTML in the original Org source. This time,
        ...
        function _EscapeSpecialCharsWithinTagAttributes(text) {
            ...
            // don't conflict with their use in Org for code, italics and strong.
            //
        ...
        function _DoAnchors(text) {
            ...
            //
            // Turn Org link shortcuts into XHTML <a> tags.
            //
            //
        ...
        function _DoImages(text) {
            ...
            //
            // Turn Org image shortcuts into <img> tags.
            //
        ...
        function _ProcessListItems(list_str, list_type, isInsideParagraphlessListItem) {
            ...
            // an aspect of Org's syntax that's hard to parse perfectly
        ...
        function _EncodeCode(text) {
            //
            // Encode/escape certain characters inside Org code runs.
            // The point is that in code, these characters are literals,
            // and lose their special Org meanings.
            //
            // Encode all ampersands; HTML entities are not
            // entities within a Org code span.
            text = text.replace(/&/g, "&amp;");
            ...
            // Now, escape characters that are magic in Org:
        ...
        function _DoItalicsAndBoldStrict(text) {
            ...
            // (\*)                The marker character itself, asterisk. Store in \2.
            ...
            // \2                  The marker character, again -- end of bold.
            // (?!\2)              Not followed by another marker character (ensuring that we match the
            //                     rightmost * in a longer row)...
            // (?=[\W_]|$)         ...but by any other non-word character or the end of string.
            text = text.replace(/(^|[\W_])(?:(?!\1)|(?=^))(\*)(?=\S)([^\r]*?\S)\2(?!\2)(?=[\W_]|$)/g, "$1<strong>$3</strong>");

            // This is almost identical to the <strong> regex, except that the marker character is now "/".
            text = text.replace(/(^|[\W_])(?:(?!\1)|(?=^))(\/)(?=\S)([^\r]*?\S)\2(?!\2)(?=[\W_]|$)/g, "$1<em>$3</em>");
            //                                              ^ -- This is the only change

            return deasciify(text);
        }

        // Wed Oct 18 11:42:18 EDT 2017 - kmodi
        // The below _DoItalicsAndBold_AllowIntrawordWithAsterisk(text) function will probably not be needed for Org bold/italics.
    ...
    }; // end of the Org.Converter constructor
